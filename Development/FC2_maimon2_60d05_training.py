...
experiment_dirs = [
    ...
    "Y:\\Data\\FCI\\Hedwig\\FC2_maimon2\\240916\\f1\\Trial3" # May actually have switching
                   ]
...
for e in experiment_dirs:
    ...
    cxa.save_phases()
#%%
datadir = "Y:\\Data\\FCI\\Hedwig\\FC2_maimon2\\240821\\f2\\Trial3"
cxa = CX_a(datadir,regions=['eb','fsb_upper','fsb_lower'],denovo=False)
#%%
plt.close('all')
cxa.simple_raw_plot(plotphase=True,regions = ['fsb_upper','fsb_lower'],yeseb = True,yk='pb')
cxa.plot_traj_arrow(cxa.pdat['phase_fsb_upper'],cxa.pdat['amp_fsb_upper']*2,a_sep=3)